...
gbm_grid <- makeParamSet(makeIntegerParam("n.trees",200,2500),
                         makeNumericParam("shrinkage",lower=0.01,upper=0.9),
...
save(bmr_gbm_full,file="../../../data/arrhythmia/ml/bmr_gbm.RData")