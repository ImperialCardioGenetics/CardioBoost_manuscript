...
## Get the hyperparameter of trained adaboost model
```{r}
bmr_ada_full$results$train$classif.ada.tuned$models[[order(bmr_ada_full$results$train$classif.ada.tuned$measures.test$imbalance_measure_1,decreasing = TRUE)[1]]]$learner.model$opt.result$x
```