...
## or with MCAP pathogenic prediction excluding the ones seen in training data
...
or_MCAP<-data.frame(gene=gene_list,or_raw=or_raw$or,or_raw_ci=paste("(",or_raw$ci_lower,or_raw$ci_upper,")"),
...
or_MCAP<-or_MCAP[order(or_MCAP$or_raw,decreasing = TRUE),]
or_MCAP<-subset(or_MCAP,is.element(gene,sarc_gene))
or_MCAP
