...
require(dplyr)
getwd()
load("../../../data/mybpc3/cm_hcm_cohort.RData")
load("../../../data/mybpc3/hvol_cm.RData")
...
save(train,file="../../../data/mybpc3/mybpc3_train.RData")
save(test,file="../../../data/mybpc3/mybpc3_holdout_test.RData")
