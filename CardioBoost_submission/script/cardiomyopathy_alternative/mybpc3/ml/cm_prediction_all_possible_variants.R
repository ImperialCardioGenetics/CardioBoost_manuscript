## generate the prediction for all possible variants in mybpc3-associated genes

rm(list=ls())
load("../../../data/mybpc3/cm_all_rare_mutation.RData")
cm_all_rare$pathogenic<-as.factor(cm_all_rare$pathogenic)
cm_all_rare<-subset(cm_all_rare,gene=="MYBPC3")

load("../../../data/mybpc3/preprocess.RData")
source("../../src/preprocess_test.R")
source("../../src/predict.R")
load("../../../data/mybpc3/ml/train_ada.RData")
...
save(cm_prediction,file="../../../data/mybpc3/prediction/cm_prediction.RData")
