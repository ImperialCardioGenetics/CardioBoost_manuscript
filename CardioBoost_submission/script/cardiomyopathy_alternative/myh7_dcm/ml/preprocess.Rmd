...
require(dplyr)
getwd()
load("../../../data/myh7_dcm/cm_dcm_cohort.RData")
load("../../../data/myh7_dcm/cm_hcm_cohort.RData")
load("../../../data/myh7_dcm/hvol_cm.RData")
...
myh7_cohort<-subset(dcm_cohort,gene=="MYH7")
...
myh7_hcm<-subset(hcm_cohort,gene=="MYH7" & pathogenic==1)
myh7_hcm<-subset(myh7_hcm,!is.element(key,myh7_cohort[which(myh7_cohort$pathogenic==1),]$key))
myh7_hcm$pathogenic<-0

train<-rbind(myh7_cohort,hvol_cm,myh7_hcm)  
...
save(train,file="../../../data/myh7_dcm/myh7_train.RData")
save(test,file="../../../data/myh7_dcm/myh7_holdout_test.RData")
...
save(impute_features,impute_mean,scale_mean,scale_std,mean_imputation,z_normalization,feature_column,disease_gene,train_imputed,file="../../../data/myh7_dcm/preprocess.RData")
save(train_scaled,file="../../../data/myh7_dcm/train_scaled.RData")
