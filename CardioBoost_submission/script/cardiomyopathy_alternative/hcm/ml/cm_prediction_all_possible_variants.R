## generate the prediction for all possible variants in hcm-associated genes

rm(list=ls())
load("../../../data/hcm/cm_all_rare_mutation.RData")
cm_all_rare$pathogenic<-as.factor(cm_all_rare$pathogenic)

load("../../../data/hcm/preprocess.RData")
source("../../src/preprocess_test.R")
source("../../src/predict.R")
load("../../../data/hcm/ml/train_ada.RData")
load("../../../data/hcm/train_scaled.RData")
...
save(cm_prediction,file="../../../data/hcm/prediction/cm_prediction.RData")
