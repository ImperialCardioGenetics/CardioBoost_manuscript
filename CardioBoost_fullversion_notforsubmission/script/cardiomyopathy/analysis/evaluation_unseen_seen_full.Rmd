...
hgmd<-read.table("/Users/xzhang13/Desktop/Onedrive/OneDrive - Imperial College London/Project1/CM/HGMD/hgmd_cm_gene_variants_2015_2.txt",sep="\t",header=T)
hgmd_dm<-subset(hgmd,CLASS=="DM")

hgmd_dm<-subset(hgmd_dm,select=c(CHROM,POS,REF,ALT))
save(hgmd_dm,file="../../../data/cardiomyopathy/hgmd_dm.RData")
