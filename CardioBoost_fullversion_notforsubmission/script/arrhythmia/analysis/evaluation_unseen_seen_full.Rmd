...
hgmd_lqts<-read.table("/Users/xzhang13/Desktop/Onedrive/OneDrive - Imperial College London/Project1/LQTS/HGMD/hgmd_lqts_gene_variants_PRO_2015_2.txt",sep="\t",header=T,stringsAsFactors = F,quote = "")

hgmd_brs<-read.table("/Users/xzhang13/Desktop/OneDrive/OneDrive - Imperial College London/Project1/Brugada/HGMD/hgmd_brs_gene_variants_2015_2.txt",sep="\t",header=T,stringsAsFactors = F,quote = "")
hgmd_brs<-subset(hgmd_brs,GENE=="SCN5A")
hgmd<-rbind(hgmd_lqts,hgmd_brs)
hgmd<-subset(hgmd,CLASS=="DM")

hgmd<-subset(hgmd,select=c(CHROM,POS,REF,ALT))



save(hgmd,file="../../../data/arrhythmia/hgmd.RData")
