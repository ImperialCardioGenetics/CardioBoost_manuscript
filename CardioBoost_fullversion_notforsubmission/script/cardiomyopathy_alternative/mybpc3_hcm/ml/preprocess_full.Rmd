...
require(dplyr)
getwd()
load("../../../../data/cardiomyopathy_alternative/mybpc3_hcm/cm_hcm_cohort.RData")
load("../../../../data/cardiomyopathy_alternative/mybpc3_hcm/hvol_cm.RData")
...
save(impute_features,impute_mean,scale_mean,scale_std,mean_imputation,z_normalization,feature_column,disease_gene,train_imputed,file="../../../data/mybpc3/preprocess.RData")
save(train_scaled,file="../../../data/mybpc3/train_scaled.RData")
