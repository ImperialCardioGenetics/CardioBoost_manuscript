...
require(dplyr)
getwd()
load("../../../../data/cardiomyopathy_alternative/hcm/cm_hcm_cohort.RData")
load("../../../../data/cardiomyopathy_alternative/dcm/cm_dcm_cohort.RData")
...
save(train,file="../../../../data/cardiomyopathy_alternative/myh7_dcm/myh7_dcm_raw_train.RData")

load("../../../../data/cardiomyopathy_alternative/myh7_dcm/myh7_dcm_raw_train.RData")
...
save(train,file="../../../../data/cardiomyopathy_alternative/myh7_dcm/myh7_dcm_train.RData")
save(test,file="../../../../data/cardiomyopathy_alternative/myh7_dcm/myh7_dcm_holdout_test.RData")
...
save(impute_features,impute_mean,scale_mean,scale_std,mean_imputation,z_normalization,feature_column,disease_gene,train_imputed,file="../../../../data/cardiomyopathy_alternative/myh7_dcm/preprocess.RData")
save(train_scaled,file="../../../../data/cardiomyopathy_alternative/myh7_dcm/train_scaled.RData")
