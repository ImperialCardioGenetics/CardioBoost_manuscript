...
save(impute_features,impute_mean,scale_mean,scale_std,mean_imputation,z_normalization,feature_column,disease_gene,train_imputed,file="../../../data/hcm/preprocess.RData")
save(train_scaled,file="../../../data/hcm/train_scaled.RData")
