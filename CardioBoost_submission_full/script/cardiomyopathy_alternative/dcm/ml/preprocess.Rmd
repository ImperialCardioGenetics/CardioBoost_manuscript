...
require(dplyr)
getwd()
load("../../../data/hcm/cm_hcm_cohort.RData")
load("../../../data/dcm/cm_dcm_cohort.RData")
load("../../../data/dcm/hvol_cm.RData")
...
train_pathogenic<-subset(train,is.element(HGVSc,dcm_cohort[which(dcm_cohort$pathogenic==1),]$HGVSc))
...
test_pathogenic<-subset(test,is.element(HGVSc,dcm_cohort[which(dcm_cohort$pathogenic==1),]$HGVSc))
test_benign<-subset(test,pathogenic==0)
test<-rbind(test_pathogenic,test_benign)
test<-subset(test,is.element(gene,train_gene))


save(train,file="../../../data/dcm/dcm_train.RData")
save(test,file="../../../data/dcm/dcm_holdout_test.RData")
