...
load("../../../data/cardiomyopathy/test_data_leakage.RData")
...
task_1 <- makeClassifTask(id = "train", data = train_scaled[,c(6,11:80,82,83)],
                          target = "pathogenic")
task_2 <- makeClassifTask(id = "train_filtered", data = train_filtered_scaled[,c(6,11:79,81,82)],
                          target = "pathogenic")
task_3 <- makeClassifTask(id="train_used_scaled",data=train_used_scaled[,c(6,11:80,82,83)],target = "pathogenic")
...
tune_control_ada <- makeTuneControlGrid(resolution = 50L)
...
save(bmr_ada_test_filtered,file="../../../data/cardiomyopathy/ml/bmr_ada_test_filtered.RData")
