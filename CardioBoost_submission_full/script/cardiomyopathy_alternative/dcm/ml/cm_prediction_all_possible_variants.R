## generate the prediction for all possible variants in dcm-associated genes

rm(list=ls())
load("../../../data/dcm/cm_all_rare_mutation.RData")

load("../../../data/dcm/preprocess.RData")
source("../../src/preprocess_test.R")
source("../../src/predict.R")
load("../../../data/dcm/ml/train_ada.RData")
load("../../../data/dcm/train_scaled.RData")
#preprocess the file

cm_all_rare$pathogenic<-as.factor(cm_all_rare$pathogenic)
cm_all_rare<-subset(cm_all_rare,is.element(gene,unique(train_scaled$gene)))
...
save(cm_prediction,file="../../../data/dcm/prediction/cm_prediction.RData")
